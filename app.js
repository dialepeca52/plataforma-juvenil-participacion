...
botonMensaje.addEventListener("click", function () {
  mensajeClase.textContent =
    "Clase 27: avanzamos en la estructura del proyecto conectando HTML, CSS y JavaScript, estoy aprendiendo a programar páginas maquias para fortalecer a mis comunidades.";
});
...
botonesPerfil.forEach(function (boton) {
  boton.addEventListener("click", function () {
    ...
    detallePerfil.innerHTML = `
      ...
      <p>
      Acá puede decir cualquier cosa </p>
    `;
  });
});